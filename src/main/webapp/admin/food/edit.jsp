...
<head>
    <jsp:include page="/admin/include/header.jsp">
        <jsp:param name="title" value="Food | Edit ${food.getName()}"/>
...
<div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
        ...
        <h5 class="pl-3">Editing <%=food.getName()%>
        </h5>

        <form class="form-horizontal" action="/admin/food/edit" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="description" placeholder="Enter description"
                           name="description" value="<%=food.getDescription()%>">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="thumbnail" placeholder="Enter thumbnail"
                           name="thumbnail" value="<%=food.getThumbnail()%>">
                </div>
            </div>
            <div class="form-group">
